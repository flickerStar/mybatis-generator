...
public class ResultMapWithoutBLOBsElementGenerator extends
    ...
    //生成mapper.xml时的<resultMap id="BaseResultMap"/>里实体类和表属性映射配置
    private void addResultMapElements(XmlElement answer) {
    	//<id column="id" property="id" jdbcType="BIGINT" />配置
      ...
      //对象的<result column="activity_id" property="activityId" jdbcType="BIGINT" />配置
